...
const deleteSessionByClientID = `-- name: DeleteSessionByClientID :exec
DELETE FROM sessions
WHERE client_ip = $1
`

func (q *Queries) DeleteSessionByClientID(ctx context.Context, clientIp string) error {
	_, err := q.db.Exec(ctx, deleteSessionByClientID, clientIp)
	return err
}
